...
export const TButton = ({
  ...
  if (link) {
    ...
    switch (color) {
      case "indigo":
        classes = [...classes, "text-indigo-500", "focus:border-indigo-500", "border border-transparent hover:border-indigo-500"];
        break;
      case "red":
        classes = [...classes, "text-red-500", "focus:border-red-500", "border border-transparent hover:border-red-500"];
    }
  } else {
