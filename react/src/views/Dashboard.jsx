    ...
    <PageComponent title="Dashboard">
      ...
      {!loading && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-gray-700">
          ...
          >
            <div className="text-5xl pb-4 font-semibold flex-1 flex items-center justify-center">
              {data.totalSurveys}
            </div>
          </DashboardCard>
            ...
            {data.latestSurvey && (
              <div className="mt-5">
                ...
                <div className="flex justify-between">
                  ...
                  <TButton
                    to={`/surveys/${data.latestSurvey.slug}/answers`}
                    link
                  >
              ...
              <div className="text-left">
                {data.latestAnswers.map((answer) => (
                  ...
                  >
                    ...
                    <small>
                      Answer at:
                      <i className="font-semibold ml-2">{answer.end_date}</i>
                    </small>
                  </a>
                ))}
              </div>
