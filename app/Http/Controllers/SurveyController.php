...
class SurveyController extends Controller
{
    ...
    /**
     * save image file in local file system and return image path
     * @param $image
     * @throws \Exception
     * @author Aung Khine Phyo (aungkhinephyo528@gmail.com)
     */
    private function saveImage($image)
    {
        // check image is valid base64 string
        if (preg_match('/^data:image\/(\w+);base64,/', $image, $type)) {
            // take out base64 encoded text without mime types
            ...
            throw new \Exception("It didn't match the data URI with image data.");
        }
